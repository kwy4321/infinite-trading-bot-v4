...
### 리버스 모드 (V4.0 PDF — 소진 후)

- **발동**: T > 분할−1 (40분할→T>39, 20분할→T>19) 자동 전환
- **첫날**: MOC 무조건 매도 (보유÷20 또는 ÷10), **매수 없음**
- **2일차~**: 별(직전 5거래일 종가 평균) **위** LOC 매도 + **아래** 쿼터매수 (잔금÷4)
- **T**: 매도 ×0.95(40분할) / ×0.9(20분할), 매수 T+(분할−T)×0.25
- **종료**: 평단 대비 TQQQ −15% / SOXL −20% 회복 시 일반모드 복귀
- **수동**: ⚙️ 설정 → **🔄 리버스 ON** (테스트·강제 진입, 첫날 플래그 설정)
